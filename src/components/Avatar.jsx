...
const Avatar = ({ path }) => {
  ...
  return (
    <button
      className={`hover:opacity-80 active:opacity-90 h-[40px] w-[40px] overflow-hidden active:border-blue-400 border-gray-200 border-[3px] rounded-full transition duration-1000 ease-in-out ${
        pathname === path && "border-blue-400"
      }`}
    >
      <img
        src={uri}
